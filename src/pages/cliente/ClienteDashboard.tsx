...
const ClienteDashboard = () => {
  ...
  const { agendamentos, loading: loadingAgendamentos } = useAgendamentosCliente();
  const { ativo: fidelidadeAtiva, loading: loadingFidelidade } = useFidelidade();

  const loading = loadingAgendamentos || loadingFidelidade;
